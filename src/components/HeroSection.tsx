...
>
  ...
  <motion.span className="block mt-2" whileHover={{ scale: 1.01 }}>
    Solutions with Innovation & Precision
        ...
        <motion.p variants={itemVariants} className="max-w-2xl mx-auto text-lg text-gray-600 dark:text-gray-400 mb-8">I'm an AI Developer & Researcher specializing in NLP, Generative AI, focusing on b[...]
        ...
        <div className="mt-8 flex flex-wrap justify-center items-center gap-4">
          <motion.a href="https://drive.google.com/file/d/1O0GJnvqjsQZdxP48Xy9gA7ojm4EXIJYw/view" target="_blank" rel="noreferrer" className="flex items-center gap-2 text-sm text-gray-700 dark:text-gr[...]
          scale: 1.05
        }} whileTap={{
          scale: 0.95
        }} initial={{
          ...
          <motion.a href="https://www.linkedin.com/in/viswadarshan-r-r-68b8b124b/" target="_blank" rel="noreferrer" className="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300 hover:te[...]
          scale: 1.05
        }} whileTap={{
          scale: 0.95
        }} initial={{
          ...
          <motion.a href="https://github.com/viswadarshan-024" target="_blank" rel="noreferrer" className="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300 hover:text-primary dark:hove[...]
          scale: 1.05
        }} whileTap={{
          scale: 0.95
        }} initial={{
          ...
          <motion.a href="https://huggingface.co/viswadarshan06" target="_blank" rel="noreferrer" className="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300 hover:text-primary dark:ho[...]
          scale: 1.05
        }} whileTap={{
          scale: 0.95
        }} initial={{
          ...
          <motion.a href="https://www.kaggle.com/viswadarshanrr" target="_blank" rel="noreferrer" className="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300 hover:text-primary dark:ho[...]
          scale: 1.05
        }} whileTap={{
          scale: 0.95
        }} initial={{
          ...
          <motion.a href="https://wa.me/6380403325" target="_blank" rel="noreferrer" className="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300 hover:text-primary dark:hover:text-prim[...]
          scale: 1.05
        }} whileTap={{
          scale: 0.95
        }} initial={{
